...
import { ArrowLeft, Send, Trash2, Phone, FileText, Users, CheckCircle, Clock, AlertCircle, Play, Pause, Square, RotateCcw, Loader, XCircle, Calendar } from 'lucide-react';
    ...
    if (!campaign) {
        return (
            <div className="max-w-2xl mx-auto text-center py-20">
                ...
                <button onClick={() => navigate('/campaigns')} className="mt-4 text-primary-600 hover:underline text-sm font-medium">
                    Back to Campaigns
                </button>
            </div>
        );
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 divide-y divide-gray-50">
                ...
                <div className="flex items-center gap-3 p-4">
                    <div className="w-9 h-9 bg-green-100 text-green-600 rounded-lg flex items-center justify-center shrink-0">
                        <FileText size={18} />
                    </div>
                    <div>
